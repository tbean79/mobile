...
public class GeneratorUtils {
    ...
    private static final EnumSet<Label> LABELS_3 = EnumSet.of(Label.DID_YOU_EVEN_CLEAN, Label.SOCIAL_WARD, Label.CLOSE_QUARTERS);
    private static final EnumSet<Label> LABELS_4 = EnumSet.allOf(Label.class);
